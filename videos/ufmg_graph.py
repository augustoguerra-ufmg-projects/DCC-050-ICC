...
class UfmgGraph(Scene):
    def construct(self):
        ...
        self.play(Write(label0, run_time=0.5))
        self.play(Write(label1, run_time=0.5))
        self.play(Write(label2, run_time=0.5))
        self.play(Write(label3, run_time=0.5))
        self.play(Write(label4, run_time=0.5))
        self.play(Write(label5, run_time=0.5))
        self.play(Write(label6, run_time=0.5))
        self.play(Write(label7, run_time=0.5))
        self.play(Write(label8, run_time=0.5))
        self.play(Write(label9, run_time=0.5))
        self.play(Write(label10, run_time=0.5))
        self.play(Write(label11, run_time=0.5))
        self.play(Write(label12, run_time=0.5))
        self.play(Write(label13, run_time=0.5))
        self.play(Write(label14, run_time=0.5))
        self.play(Write(label15, run_time=0.5))
        self.play(Write(label16, run_time=0.5))
        self.play(Write(label17, run_time=0.5))
        self.play(Write(label18, run_time=0.5))
        self.play(Write(label19, run_time=0.5))
        self.play(Write(label20, run_time=0.5))
        self.play(Write(label21, run_time=0.5))
